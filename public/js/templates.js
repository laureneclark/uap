...
templates['exhibit'] = template({"1":function(depth0,helpers,partials,data) {
  ...
  return buffer + "            </div>\n	 	<form id=\"add-piece-form\" class=\"form-inline\">\n\n	     	<div class=\"form-group\">\n	 	    	<label for=\"add-piece-title\"> Title </label>\n				<input type=\"text\" name=\"title\" id =\"add-piece-title\" class=\"form-control\" placeholder=\"RPiece Title\" required />\n			</div>\n\n			<div class=\"form group\">\n				<label for=\"add-piece-year\"> Year </label>\n				<input type=\"text\" name=\"year\" id=\"add-piece-year\" class=\"form-control\" required>\n	      	</div>\n\n			<div class=\"form group\">\n				<label for=\"add-piece-artist\"> Atrist </label>\n				<input type=\"text\" name=\"artist\" id=\"add-piece-artist\" class=\"form-control\" required>\n	      	</div>\n\n	     	<div class=\"form-group\">\n	 	    	<label for=\"add-piece-description\"> Description </label> \n				<input type=\"text\" name=\"description\" id =\"add-piece-description\" class=\"form-control\" placeholder=\"Piece Description\" required />\n			</div>\n	     	<div class=\"form-group\">\n	 	    	<label for=\"add-piece-image\"> Image </label> \n				<input type=\"text\" name=\"description\" id =\"add-piece-image\" class=\"form-control\" placeholder=\"Image Link\" required />\n			</div>\n  		</form>\n	</div>\n        <div class=\"modal-footer\">\n        <button type=\"button\" class=\"btn\" data-dismiss=\"modal\">Close</button>\n          <button type=\"button\" class=\"btn edit-btn\" exhibit_id="
    + escapeExpression(lambda(((stack1 = (depth0 != null ? depth0.exhibit : depth0)) != null ? stack1._id : stack1), depth0))
    + " id=\"add-piece-btn\">Add</button>\n        </div>\n      </div>\n    </div>\n  </div>\n\n		<button class=\"btn btn-lg \" exhibit_id="
    + escapeExpression(lambda(((stack1 = (depth0 != null ? depth0.exhibit : depth0)) != null ? stack1._id : stack1), depth0))
  ...
  stack1 = helpers['if'].call(depth0, (depth0 != null ? depth0.error : depth0), {"name":"if","hash":{},"fn":this.program(1, data),"inverse":this.noop,"data":data});
  if (stack1 != null) { buffer += stack1; }
  buffer += "	</div>\n		<button class=\"edit-btn btn-sm\" id=\"visit-exhibit-btn\" exhibit_id="
    + escapeExpression(lambda(((stack1 = (depth0 != null ? depth0.exhibit : depth0)) != null ? stack1._id : stack1), depth0))
    + ">Visit</button>\n";
  ...
  stack1 = helpers.each.call(depth0, ((stack1 = (depth0 != null ? depth0.exhibit : depth0)) != null ? stack1.pieces : stack1), {"name":"each","hash":{},"fn":this.program(6, data),"inverse":this.noop,"data":data});
  if (stack1 != null) { buffer += stack1; }
  ...
  stack1 = helpers.each.call(depth0, ((stack1 = (depth0 != null ? depth0.exhibit : depth0)) != null ? stack1.resources : stack1), {"name":"each","hash":{},"fn":this.program(8, data),"inverse":this.noop,"data":data});
  if (stack1 != null) { buffer += stack1; }
  ...
  stack1 = helpers.each.call(depth0, ((stack1 = (depth0 != null ? depth0.exhibit : depth0)) != null ? stack1.influences : stack1), {"name":"each","hash":{},"fn":this.program(10, data),"inverse":this.noop,"data":data});
  if (stack1 != null) { buffer += stack1; }
  return buffer + "		<p> </p>\n    </div>\n  </div>\n\n</div>";
},"usePartial":true,"useData":true});
...
templates['piece'] = template({"1":function(depth0,helpers,partials,data) {
  ...
  if (stack1 != null) { buffer += stack1; }
  stack1 = helpers.each.call(depth0, (depth0 != null ? depth0.contributions : depth0), {"name":"each","hash":{},"fn":this.program(4, data),"inverse":this.noop,"data":data});
  if (stack1 != null) { buffer += stack1; }
  return buffer;
},"4":function(depth0,helpers,partials,data) {
  var stack1, buffer = "";
  ...
  var stack1, helper, lambda=this.lambda, escapeExpression=this.escapeExpression, functionType="function", helperMissing=helpers.helperMissing, buffer = "<h1>"
  ...
  stack1 = helpers.each.call(depth0, (depth0 != null ? depth0.conversation : depth0), {"name":"each","hash":{},"fn":this.program(3, data),"inverse":this.noop,"data":data});
  if (stack1 != null) { buffer += stack1; }
  return buffer + "  </div>\n</div>\n";
},"usePartial":true,"useData":true});
