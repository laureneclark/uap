...
templates['exhibit'] = template({"1":function(depth0,helpers,partials,data) {
  ...
  stack1 = helpers['if'].call(depth0, ((stack1 = (depth0 != null ? depth0.exhibit : depth0)) != null ? stack1.published : stack1), {"name":"if","hash":{},"fn":this.program(2, data),"inverse":this.noop,"data":data});
  if (stack1 != null) { buffer += stack1; }
  ...
  stack1 = helpers['if'].call(depth0, (depth0 != null ? depth0['form-error'] : depth0), {"name":"if","hash":{},"fn":this.program(4, data),"inverse":this.noop,"data":data});
  if (stack1 != null) { buffer += stack1; }
  buffer += "            </div>\n	 	<form id=\"add-influence-form\" class=\"form-inline\">\n\n			<div class=\"form group\">\n				<label for=\"add-influence-piece\">Piece ID</label>\n				<input type=\"text\" name=\"piece\" id=\"add-influence-piece\" class=\"form-control\" required>\n	      	</div>\n\n	     	<div class=\"form-group\">\n	 	    	<label for=\"add-influence-description\">Description</label> \n				<input type=\"text\" name=\"description\" id =\"add-influence-description\" class=\"form-control\" placeholder=\"Description of Influence Impact\" required />\n			</div>\n  		</form>\n	</div>\n        <div class=\"modal-footer\">\n        <button type=\"button\" class=\"btn\" data-dismiss=\"modal\">Close</button>\n          <button type=\"button\" class=\"btn edit-btn\" exhibit_id="
    + escapeExpression(lambda(((stack1 = (depth0 != null ? depth0.exhibit : depth0)) != null ? stack1._id : stack1), depth0))
    + " id=\"add-influence-btn\">Add</button>\n        </div>\n      </div>\n    </div>\n  </div>\n\n\n\n\n	\n";
  stack1 = helpers.unless.call(depth0, ((stack1 = (depth0 != null ? depth0.exhibit : depth0)) != null ? stack1.published : stack1), {"name":"unless","hash":{},"fn":this.program(6, data),"inverse":this.noop,"data":data});
  if (stack1 != null) { buffer += stack1; }
  return buffer + "	</div>\n	</div>\n	</div>\n	</div>\n	<div class=\"col-md-7\">\n	<div class=\"metrics\">\n		<div class=\"panel panel-primary\">\n		<div class=\"panel-heading\">\n			Metrics\n		</div>\n		<div class=\"panel-body\">\n			Number of Saved Resources: "
    + escapeExpression(lambda(((stack1 = (depth0 != null ? depth0.metrics : depth0)) != null ? stack1.numSaved : stack1), depth0))
    + "  <p> Number of Visitors: "
    + escapeExpression(lambda(((stack1 = (depth0 != null ? depth0.metrics : depth0)) != null ? stack1.numVisitors : stack1), depth0))
    + "  <p>Number of Contributions: "
    + escapeExpression(lambda(((stack1 = (depth0 != null ? depth0.metrics : depth0)) != null ? stack1.numContributed : stack1), depth0))
    + "\n		</div>\n		</div>\n	</div>\n</div>\n</div>\n";
  ...
  var stack1, lambda=this.lambda, escapeExpression=this.escapeExpression, buffer = "\n	<!-- Form for visiting an exhibit-->\n  	<button class=\"btn btn-sm\" data-toggle=\"modal\" data-target=\"#visit-modal\" id=\"visit-modal-btn\">Visit</button>\n  	<!-- Modal -->\n  	<div class=\"modal fade\" id=\"visit-modal\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"visit-modal-label\" aria-hidden=\"true\">\n    <div class=\"modal-dialog\">\n      <div class=\"modal-content\"> \n        <div class=\"modal-header\">\n          <button type=\"button\" class=\"close\" data-dismiss=\"modal\">\n            <span aria-hidden=\"true\">&times;</span><span class=\"sr-only\">Close</span>\n          </button>\n          <h3 class=\"modal-title\" id=\"visit-modal-label\">Enter Exhibit Code</h3>\n        </div>\n        <div class=\"modal-body\">\n            <div class=\"form-error\">\n";
  stack1 = helpers['if'].call(depth0, (depth0 != null ? depth0['form-error'] : depth0), {"name":"if","hash":{},"fn":this.program(4, data),"inverse":this.noop,"data":data});
  if (stack1 != null) { buffer += stack1; }
  return buffer + "            </div>\n	 	<form id=\"visit-form\" class=\"form-inline\">\n\n			<div class=\"form group\">\n<!-- 				<label for=\"visit-code\"></label> -->\n				<input type=\"text\" name=\"code\" id=\"visit-code\" class=\"form-control\" required>\n	      	</div>\n\n  		</form>\n	</div>\n        <div class=\"modal-footer\">\n        <button type=\"button\" class=\"btn\" data-dismiss=\"modal\">Close</button>\n          <button type=\"button\" class=\"btn edit-btn\" exhibit_id="
    + escapeExpression(lambda(((stack1 = (depth0 != null ? depth0.exhibit : depth0)) != null ? stack1._id : stack1), depth0))
    + " id=\"visit-exhibit-btn\">Add</button>\n        </div>\n      </div>\n    </div>\n  </div>\n";
  ...
  var stack1, lambda=this.lambda, escapeExpression=this.escapeExpression, buffer = "<div id=\"curator\">\n";
  stack1 = helpers['if'].call(depth0, (depth0 != null ? depth0.madeByUser : depth0), {"name":"if","hash":{},"fn":this.program(1, data),"inverse":this.noop,"data":data});
  if (stack1 != null) { buffer += stack1; }
  buffer += "	<div class = \"page-header\">\n	    <h1> "
    ...
    + " </h1>\n	</div>\n\n	<div class=\"error\">\n";
  stack1 = helpers['if'].call(depth0, (depth0 != null ? depth0.error : depth0), {"name":"if","hash":{},"fn":this.program(8, data),"inverse":this.noop,"data":data});
  if (stack1 != null) { buffer += stack1; }
  buffer += "	</div>\n	<div class=\"row\">\n  		<div class = 'description-panel col-md-8'>\n  			<h5> "
    + escapeExpression(lambda(((stack1 = (depth0 != null ? depth0.exhibit : depth0)) != null ? stack1.description : stack1), depth0))
    + "</h5>\n  		</div>\n  		<div class='col-md-4'>\n  		<div class = \"information-panel panel-primary panel\">\n  		<div class=\"panel-body\">\n  			<h4> Start Date: "
    ...
    + " </h4>\n			</div>\n			</div>\n";
  stack1 = helpers['if'].call(depth0, (depth0 != null ? depth0.visitor : depth0), {"name":"if","hash":{},"fn":this.program(10, data),"inverse":this.noop,"data":data});
  if (stack1 != null) { buffer += stack1; }
...
templates['influence-panel'] = template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  ...
  return "<div class=\"thumbnail thumbnail-influence\">\n	<img src="
    + escapeExpression(lambda(((stack1 = (depth0 != null ? depth0.piece : depth0)) != null ? stack1.image : stack1), depth0))
    + ">\n		<div class=\"caption\">\n			<h3>"
    + escapeExpression(lambda(((stack1 = (depth0 != null ? depth0.piece : depth0)) != null ? stack1.title : stack1), depth0))
    + "</h3>\n			<p>"
...
templates['piece-preview'] = template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  var helper, functionType="function", helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression;
  return "<div class=\"thumbnail thumbnail-piece-pre\">\n	<img src="
    + escapeExpression(((helper = (helper = helpers.image || (depth0 != null ? depth0.image : depth0)) != null ? helper : helperMissing),(typeof helper === functionType ? helper.call(depth0, {"name":"image","hash":{},"data":data}) : helper)))
    + ">\n		<div class=\"caption\">\n			<h3>"
    + escapeExpression(((helper = (helper = helpers.title || (depth0 != null ? depth0.title : depth0)) != null ? helper : helperMissing),(typeof helper === functionType ? helper.call(depth0, {"name":"title","hash":{},"data":data}) : helper)))
    + "</h3>\n			<p>"
...
templates['piece'] = template({"1":function(depth0,helpers,partials,data) {
  var stack1, lambda=this.lambda, escapeExpression=this.escapeExpression;
  return "      <button class=\"btn btn-sm\" id=\"favorite-piece-btn\" piece_id="
    + escapeExpression(lambda(((stack1 = (depth0 != null ? depth0.piece : depth0)) != null ? stack1._id : stack1), depth0))
    + ">Favorite</button>\n      <p>\n";
},"3":function(depth0,helpers,partials,data) {
  var helper, functionType="function", helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression;
  ...
  if (stack1 != null) { buffer += stack1; }
  stack1 = helpers.each.call(depth0, (depth0 != null ? depth0.contributions : depth0), {"name":"each","hash":{},"fn":this.program(11, data),"inverse":this.noop,"data":data});
  if (stack1 != null) { buffer += stack1; }
  return buffer;
  ...
  var stack1, lambda=this.lambda, escapeExpression=this.escapeExpression, buffer = "\n<p>\n<div class=\"row back-btn\">\n<div class=\"col-md-12\">\n<button class=\"btn btn-sm back-to-exhibit\" id="
    ...
    + "</h3>\n\n";
  stack1 = helpers.unless.call(depth0, (depth0 != null ? depth0.createdBy : depth0), {"name":"unless","hash":{},"fn":this.program(1, data),"inverse":this.noop,"data":data});
  if (stack1 != null) { buffer += stack1; }
  buffer += "  </div>\n  <div class=\"col-md-6\">\n    <div class=\"piece-description\">\n      <h4>"
    + escapeExpression(lambda(((stack1 = (depth0 != null ? depth0.piece : depth0)) != null ? stack1.description : stack1), depth0))
    + "</h4>\n    </div>\n  </div>\n</div>\n\n<div class=\"error\">\n";
  ...
  stack1 = helpers['if'].call(depth0, (depth0 != null ? depth0.createdBy : depth0), {"name":"if","hash":{},"fn":this.program(7, data),"inverse":this.noop,"data":data});
  if (stack1 != null) { buffer += stack1; }
  stack1 = helpers.each.call(depth0, (depth0 != null ? depth0.conversation : depth0), {"name":"each","hash":{},"fn":this.program(10, data),"inverse":this.noop,"data":data});
  if (stack1 != null) { buffer += stack1; }
  return buffer + "  </div>\n</div>\n";
},"usePartial":true,"useData":true});
templates['question-panel'] = template({"1":function(depth0,helpers,partials,data) {
  ...
  var stack1, helper, lambda=this.lambda, escapeExpression=this.escapeExpression, functionType="function", helperMissing=helpers.helperMissing, buffer = "<div class=\"panel-primary panel-deafult panel question\">\n	<div class=\"panel-heading question-header\">Posted by "
    + escapeExpression(lambda(((stack1 = ((stack1 = (depth0 != null ? depth0.author : depth0)) != null ? stack1.local : stack1)) != null ? stack1.username : stack1), depth0))
    + " at "
    + escapeExpression(((helper = (helper = helpers.time || (depth0 != null ? depth0.time : depth0)) != null ? helper : helperMissing),(typeof helper === functionType ? helper.call(depth0, {"name":"time","hash":{},"data":data}) : helper)))
...
templates['resource-panel'] = template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  ...
  return "<h3>"
    ...
    + "</a>\n<button class=\"btn btn-sm\" id=\"save-resource-btn\" resource_id="
    + escapeExpression(((helper = (helper = helpers._id || (depth0 != null ? depth0._id : depth0)) != null ? helper : helperMissing),(typeof helper === functionType ? helper.call(depth0, {"name":"_id","hash":{},"data":data}) : helper)))
    + ">Save</button>";
},"useData":true});
...
templates['user'] = template({"1":function(depth0,helpers,partials,data) {
  ...
  if (stack1 != null) { buffer += stack1; }
  buffer += "	</div>\n\n	<div id=\"favorited-pieces\">\n		<h2>Pieces You Have Favorited</h2>\n		<div class=\"row\">\n";
  stack1 = helpers.each.call(depth0, ((stack1 = (depth0 != null ? depth0.user : depth0)) != null ? stack1.favorites : stack1), {"name":"each","hash":{},"fn":this.program(7, data),"inverse":this.noop,"data":data});
  if (stack1 != null) { buffer += stack1; }
  return buffer + "		</div>\n	</div>\n</div>";
},"usePartial":true,"useData":true});
